...
QString styleSheetForAppearance(const QString& theme, const QString& chatTheme,
    ...
    return QStringLiteral(R"(
      ...
      /* Putting a border on QSpinBox switches it to the stylesheet style; the
         up/down buttons must then be given explicit geometry or their click
         areas break (they render but do nothing). */
      QSpinBox::up-button {
